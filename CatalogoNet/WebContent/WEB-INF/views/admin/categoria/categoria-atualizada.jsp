	...
	<div id="pagina" class="row-fluid">
		...
		<div class="conteudo-pagina col-md-10">
			...
			<div class="page-header">
				<div class="alert alert-success" role="alert">Categoria atualizada com sucesso!</div>
				<div class="alert alert-danger" role="alert">A categoria foi atualizada com sucesso, porem só estará disponível quando a lista de categorias for renovada!</div>
			</div>
		</div>
		<!-- fim conteudo pagina -->
