	...
	<div id="pagina" class="row-fluid">
		...
		<div class="conteudo-pagina col-md-10">
			...
			<div class="page-header">
				<h1>Editar categoria <small>${categoria.nome}</small></h1>
			</div>



			<c:url var="atualizar" value="/adminadmin/categorias/atualizar-categoria-handle" />
			<form:form modelAttribute="categoria" action="${atualizar}" method="post">
				<div class="form-group">
					<label for="id">ID: ${categoria.id}</label>
