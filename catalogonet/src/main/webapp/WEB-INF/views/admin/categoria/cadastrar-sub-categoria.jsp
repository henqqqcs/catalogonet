	...
	<div id="pagina" class="row-fluid">
		...
		<div class="conteudo-pagina col-md-10">
			...
			<div class="page-header">
				<h1>Cadastrar nova sub categoria </h1>
			</div>

			<div>
				<p>Você irá adicionar uma nova sub categoria a <label>Nome da categoria</label>.
			</div>


			<form>
				<div class="form-group">
					<label for="exampleInputEmail1">Nome da sub categoria</label>
					<input type="text" class="form-control" name="nome" placeholder="Restaurante">
				</div>

				
				<div id="tags-wrapper"class="form-group">
					<label for="exampleInputEmail1">Tags utlizadas pelo sistema de busca</label> (Max. 5)<br/>
					...
					<input type="text" class="form-control" name="tag" placeholder="restaurante"><br/>
