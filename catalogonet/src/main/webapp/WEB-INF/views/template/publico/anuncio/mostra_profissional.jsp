...
$(document).ready(function() {
    ...
    $(".fb-comments").attr("data-href", $(location).attr('href'))
		...
		<div id="barraFerramentasProfissional">
				&nbsp;
		...
		<div id="maisInfoProfissional">
			<p class="textoMeioMedio negrito"> Mais Informções </p> <br />
