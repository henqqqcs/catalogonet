	...
	<div id="pagina" class="row-fluid">
		...
		<div class="conteudo-pagina col-md-10">
			...
			<div class="page-header">
				...
				<div class="alert alert-danger" role="alert">A categoria foi cadastrada com sucesso, porem só estará disponível quando a lista de categorias for renovada!</div>
			</div>
		</div>
		<!-- fim conteudo pagina -->
