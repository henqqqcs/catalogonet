...
<!-- fim row pgr-tracker -->
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<h3><strong>Pronto! Seu anúncio gratuito foi criado!</strong></h3>
				<hr/>

				<div class="anuncio-criado-text">
					<p>Seu anúncio gratuito foi criado com sucesso, e estará disponível assim que for aprovado.</p>
				</div>

				<div class="anuncio-criado-text">
					<p>Para atualizar informações e gerenciar seus anúncios clique no botão abaixo.</p>
				</div>
				...
				<div class="anuncio-criado-text">
					<p>Caso queira contratar um plano pago para seu anúncio, e adquirir mais visibilidade para o seu negócio, você pode fazer um upgrade a qualquer momento na área da empresa.</p>
				</div>

				<div class="anuncio-criado-link">
					<a class="btn btn-black" href="">Fazer um upgrade!</a>
				</div>
