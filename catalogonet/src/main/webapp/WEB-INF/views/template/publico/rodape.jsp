...
<footer id="footer">
	...
	<div class="container">
		...
		<div class="footer-social-icons">
			...
			<a target="_blank" href="#"><img class="footer-social-item" src="${facebook}"
				alt="facebook-icon" /></a>
			<c:url var="twitter" value="/resources/publico/imagens/twitter-icon.png" />
			<a target="_blank" href="#"><img class="footer-social-item" src="${twitter}"
				alt="twitter-icon" /></a>
			<c:url var="google" value="/resources/publico/imagens/google-plus-icon.png" />
			<a target="_blank" href="#"><img class="footer-social-item" src="${google}"
		...
		<div class="footer-payment">
			...
			<div class="footer-content">
				...
				<form action="${subscribeUrl}" method="POST">
					<input class="form-control" id="emailSubscribe" name="emailSubscribe"
						placeholder="seu@email.com" />
					<button type="submit" id="emailSubscribeBtn" class="btn btn-primary btn-block">Quero
						Receber!</button>
				</form>
			</div>
							...
							$.ajax({
								...
								success : function(data) {
									...
									$("#messageSubscribe").html(
											'Pronto! Seu email foi cadastrado')
											.slideDown('slow');
									$("#messageSubscribe").addClass(
											"alert alert-success");
								},
								error : function(data) {
									$("#country").val('');
									$("#messageSubscribe").html(
											'Ops! Este email está correto?')
											.slideDown('slow');
									$("#messageSubscribe").addClass(
											"alert alert-danger");
								}
