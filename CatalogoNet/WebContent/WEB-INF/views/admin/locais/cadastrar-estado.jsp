	...
	<div id="pagina" class="row-fluid">
		...
		<div class="conteudo-pagina col-md-10">
			...
			<div class="page-header">
				...
				<c:url var="cadastrar" value="/adminadmin/locais/cadastrar-estado-handle" />
				<form:form modelAttribute="estado" action="${cadastrar}" method="post">
				  <div class="form-group">
				    <label for="nome">Nome do estado</label>
				    <input type="text" class="form-control" id="nome" name="nome" placeholder="Distrito Federal">
				  </div>
				  <div class="form-group">
				  	<label for="nome">Sigla do estado</label>
				    <input type="text" class="form-control" id="id" name="id" placeholder="DF">
				  </div>

				  <button type="submit" class="btn btn-primary">Cadastrar</button>
				</form:form>
				<!-- fim form cadastro estado -->
